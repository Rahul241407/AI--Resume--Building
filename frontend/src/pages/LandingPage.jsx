...
import { ArrowBigDown, ArrowBigRight, ArrowRight, Download, LayoutTemplate, Menu, X, Zap  } from 'lucide-react';
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>
                  JOin thousands of professional who landed their dream jobs with the platform
                </p>
        ...
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            Crafted with <span className={landingPageStyles.footerHeart}>❤️</span> by{' '}
             <a href='https://www.hexagondigitalservices.com/' target='_blank' className={landingPageStyles.footerLink}>
