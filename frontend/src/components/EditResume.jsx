...
import { AlertCircle, ArrowLeft, Check, Download, Loader, Loader2, Palette, Save, SaveAll, Trash2 } from 'lucide-react'
...
const EditResume = () => {
  ...
  // TAKE BACK TO PREVIOUS FORM STATE OR TAKE BACK TO FIRST PAGE
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
 ...
 const renderForm = () => {
  ...
  // UPDATE THE ARRAY ITEMS USING INDEX
  ...
  // IT WILL HELP IN CHOOSING THE PREVIEW AS WELL HELPS IN DOWNLOADING THE RESUME ALSOO SAVE THE RESUME AS AN IMAGE
...
const downloadPDF = async () => {
    ...
    // TYPE OF HOW IT WILL LOOK WHEN DOWNLOAD.
    try {
      await html2pdf()
        .set({
          margin:       0,
  ...
  // SO ALL THIS FUNCTION WILL BE USED FOR EDIT RESUME.
            ...
            <div className='p-4 sm:p-6'>
                ...
                <div className='flex flex-wrap items-center justify-end gap-3'>
                  ...
                  <button className={buttonStyles.next} onClick={validateAndNext} disabled={isLoading}>
                    ...
                    {currentPage === "additionalInfo" && <ArrowLeft size={16} className='routate-180'/>}
                ...
                <div className={containerStyles.pdfPreview}>
                  <div className='a4-wrapper' ref={resumeDownloadRef}>
                    <div className='w-full h-full'>
                      ...
                      templatedId={resumeData?.template?.theme || "" }
                      resumeData={resumeData}
                      containerWidth={null}
                    />
                    </div>
